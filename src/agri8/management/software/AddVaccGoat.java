...
public class AddVaccGoat extends javax.swing.JFrame {
    ...
    private void goatComboBox() {
        
         try {
                 
                 Connection conn = myConnection.getConnect();
                Statement stm = conn.createStatement();
                ResultSet rs = stm.executeQuery("SELECT g_tag_id, g_name, g_dob FROM tbl_goat_info");
                 
                 while(rs.next()){
                     
                     jcvID.addItem(rs.getString("g_tag_id"));
    ...
    private void goatDetails() {
        ...
        String goatID = (String) jcvID.getSelectedItem();
         ...
         try {
               ...
               Connection conn = myConnection.getConnect();
                String sql = ("SELECT g_name, g_dob FROM tbl_goat_info WHERE g_tag_id = ?");
                ...
                if(rs.next()){
                     ...
                     tfvName.setText(rs.getString("g_name"));
                     tfvDob.setText(rs.getString("g_dob")) ;
    ...
    private void kidComboBox() {
        
         try {
                 
                Connection conn = myConnection.getConnect();
                Statement stm = conn.createStatement();
                ResultSet rs = stm.executeQuery("SELECT g_tag_id, g_name, g_dob FROM tbl_kid_info");
     ...
     private void kidDetails() {
        ...
        String goatID = (String) jcvID.getSelectedItem();
         ...
         try {
                 ...
                 Connection conn = myConnection.getConnect();
                String sql = ("SELECT g_name, g_dob FROM tbl_kid_info WHERE g_tag_id = ?");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Goat Vaccination / Disease Record");
        ...
        btnAddV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttonAdd.png"))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jcAddDisease, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jcvA, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(tfvDob, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(tfvDosage, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGap(35, 35, 35))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btnAddV, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnClearV, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnCloseV, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(31, 31, 31)))))
                .addContainerGap())
        );
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 840, 320));

        jLabel90.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel90.setForeground(new java.awt.Color(255, 255, 255));
        jLabel90.setText("Add / Delete Treatement:");
        getContentPane().add(jLabel90, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 380, -1, -1));
        ...
        getContentPane().add(btnAddVaccination, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 370, 40, 40));
        ...
        getContentPane().add(btnDeleteVaccination, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 370, 40, 40));

        jLabel87.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel87.setForeground(new java.awt.Color(255, 255, 255));
        jLabel87.setText("Add / Delete Disease:");
        getContentPane().add(jLabel87, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 380, -1, -1));
        ...
        getContentPane().add(btnAddDisease, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 370, 40, 40));
        ...
        getContentPane().add(btnDeleteDisease, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 370, 40, 40));
        ...
        getContentPane().add(lbbackground, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 890, 440));
           ...
           JOptionPane.showMessageDialog(null, "All fields are mandatory to be completed!", "AGRI8 ASSIST DIALOG", JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                ...
                Connection conn = myConnection.getConnect();
                   ...
                   //Save new Animale
                    String saveQuery = "INSERT INTO tbl_vacc_goats(gv_id, gv_name, gv_dob, gv_disease, gv_vacc, gv_app, gv_dosage, gv_treatementDate, gv_nexttreatment, gv_employee, gv_note)" +
                            "values( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
