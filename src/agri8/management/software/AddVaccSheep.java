...
public class AddVaccSheep extends javax.swing.JFrame {
    ...
    private void SheepComboBox() {
        
         try {
                 
                 Connection conn = myConnection.getConnect();
                Statement stm = conn.createStatement();
                ResultSet rs = stm.executeQuery("SELECT s_tag_id, s_name, s_dob FROM tbl_sheep_info");
                 
                 while(rs.next()){
                     
                     jcvID.addItem(rs.getString("s_tag_id"));
    ...
    private void SheepDetails() {
        // Fill Textfield when choosing cattle ID in JComboBox
        
        String sheepID = (String) jcvID.getSelectedItem();
        
         try {
                 
               Connection conn = myConnection.getConnect();
                String sql = ("SELECT s_name, s_dob FROM tbl_sheep_info WHERE s_tag_id = ?");
                
                PreparedStatement psm = conn.prepareStatement(sql);
                psm.setString(1, sheepID);
                ResultSet rs = psm.executeQuery();
                 
                if(rs.next()){
                    
                     tfvName.setText(rs.getString("s_name"));
                     tfvDob.setText(rs.getString("s_dob")) ;
    ...
    //***************** Sheep manditory Information ************************
    
    private void LambComboBox() {
        
         try {
                 
                Connection conn = myConnection.getConnect();
                Statement stm = conn.createStatement();
                ResultSet rs = stm.executeQuery("SELECT s_tag_id, s_name, s_dob FROM tbl_lamb_info");
     ...
     private void LambDetails() {
        // Fill Textfield when choosing calf ID in JComboBox
        
        String goatID = (String) jcvID.getSelectedItem();
        
         try {
                 
                 Connection conn = myConnection.getConnect();
                String sql = ("SELECT s_name, s_dob FROM tbl_lamb_info WHERE s_tag_id = ?");
                
                PreparedStatement psm = conn.prepareStatement(sql);
                psm.setString(1, goatID);
                ResultSet rs = psm.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Sheep Vaccination / Disease Record");
        ...
        tfvName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tfvNameFocusGained(evt);
            }
        });
        ...
        btnAddV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-sheep-16.png"))); // NOI18N
        ...
        jcVacc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "Castration", "Dipping", "Docking", "Hoof Trimming" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jcvA, 0, 170, Short.MAX_VALUE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(tfvDob, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
                                    .addComponent(jcVacc, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jcAddDisease, 0, 0, Short.MAX_VALUE))
                                .addGap(81, 81, 81))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(64, 64, 64)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tfvName, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jcvID, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(68, 68, 68)))
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(23, 23, 23)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(tfvEmployee, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGap(35, 35, 35))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btnAddV, javax.swing.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(btnClearV, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnCloseV, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15)))))
                .addContainerGap())
        );
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 750, 320));

        jLabel90.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel90.setForeground(new java.awt.Color(255, 255, 255));
        jLabel90.setText("Add / Delete Treatement:");
        getContentPane().add(jLabel90, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 360, -1, -1));
        ...
        getContentPane().add(btnAddVaccination, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 350, 40, 40));
        ...
        getContentPane().add(btnDeleteVaccination, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, 40, 40));

        jLabel87.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel87.setForeground(new java.awt.Color(255, 255, 255));
        jLabel87.setText("Add / Delete Disease:");
        getContentPane().add(jLabel87, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, -1, -1));
        ...
        getContentPane().add(btnAddDisease, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 350, 40, 40));
        ...
        getContentPane().add(btnDeleteDisease, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 350, 40, 40));
        ...
        getContentPane().add(lbbackground, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 810, 410));
    ...
    private void btnAddVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddVActionPerformed
        ...
        if(vidtag.equals("SELECT") || vdisease.equals("SELECT") || vacc.equals("SELECT")|| vapplication.equals("SELECT") ||
           ...
           JOptionPane.showMessageDialog(null, "All fields are ( * ) are mandatory to be completed!", "AGRI8 ASSIST DIALOG", JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                ...
                Connection conn = myConnection.getConnect();
                   ...
                   //Save new Animale
                    String saveQuery = "INSERT INTO tbl_vacc_sheep(sv_id, sv_name, sv_dob, sv_disease, sv_vacc, sv_app, sv_dosage, sv_treatementDate, sv_nexttreatment, sv_employee, sv_note)" +
                            "values( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void jcvIDFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jcvIDFocusGained
        SheepComboBox();     //goat IDs
        LambComboBox();     //Kid IDs
       
    }//GEN-LAST:event_jcvIDFocusGained

    private void tfvNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfvNameFocusGained

    }//GEN-LAST:event_tfvNameFocusGained
